...
<div class="contact-bg-svg" aria-hidden="true">
    <svg width="100%" height="100%" viewBox="0 0 1440 320" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <ellipse cx="720" cy="160" rx="900" ry="180" fill="url(#contactGradient)"/>
    </svg>
</div>

<!-- Page Header -->
<section class="page-header contact-header-glass" style="background: var(--gradient-primary); padding: 8rem 0 4rem; margin-top: 60px; text-align: center; color: var(--text-white); position:relative; z-index:2;">
    <div class="container">
...
<!-- Contact Section -->
<section class="contact-section contact-section-glass" style="padding: 6rem 0; position:relative; z-index:2;">
    <div class="container">
        <div class="contact-layout">
            <!-- Contact Information -->
            <aside class="contact-info contact-info-glass" data-aos="fade-right" aria-label="Contact Information">
            ...
            <!-- Contact Form -->
            <div class="contact-form-container contact-form-glass" data-aos="fade-left">
                <div class="form-card">
